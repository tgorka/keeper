...
### DW-114: The desktop app never starts the sync supervisor, and nothing anywhere constructs the filesystem watcher — so in the app "folder sync" only ever happens when the user presses "Sync now".
