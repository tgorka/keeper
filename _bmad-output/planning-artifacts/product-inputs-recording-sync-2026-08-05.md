...
| FR-127 | The rendered path is filesystem-safe on APFS, exFAT and NTFS: no `:`, no leading/trailing separator or space, no `..`, never absolute; an empty `{slug}` collapses without leaving a separator or an "Untitled" placeholder. |
