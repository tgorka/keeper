    ...
    macro_rules! keeper_with_commands {
        ($builder:expr $(, $extra:path)* $(,)?) => {
            $builder.invoke_handler(tauri::generate_handler![
                ...
                ipc::recording_capture_sources_get,
                ipc::recording_capture_sources_set,
                ...
                notes_ipc::notes_note_marks,
                notes_ipc::notes_service_file_names_get,
                notes_ipc::notes_service_file_names_set,
                notes_ipc::notes_hide_service_files_get,
                notes_ipc::notes_hide_service_files_set,
                notes_ipc::notes_include_private_get,
                notes_ipc::notes_include_private_set,
                notes_ipc::notes_embedding_model_get,
                notes_ipc::notes_embedding_model_set,
                notes_ipc::notes_subscribe_search,
                ...
                notes_ipc::notes_space_touch,
                notes_ipc::notes_space_park,
