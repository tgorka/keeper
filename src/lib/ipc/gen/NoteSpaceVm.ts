 ...
 */
export type NoteSpaceVm = { restore: NoteSpaceRestoreVm, pinned: boolean, ttlHours: number | null, expiresMs: number | null, text: string | null, parent: string | null, leafName: string, depth: number, descendants: number, expiryPhrase: string, 
/**
